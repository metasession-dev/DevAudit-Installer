...
All notable changes to `@metasession/devaudit-cli` are documented here. The CLI follows semver.

## [Unreleased]

## [0.1.0] — 2026-05-19

First public release. Package renamed from `@metasession-dev/devaudit-cli` (GitHub org scope) to `@metasession/devaudit-cli` (npm org scope). Repo flipped public; Apache-2.0 licensed. Published to npmjs.org with SLSA provenance.
