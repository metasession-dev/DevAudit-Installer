...
| Doc                                                                                                       | What                                                                                                                                                                                  |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Start here — concept overviews**                                                                        |                                                                                                                                                                                       |
| [`docs/sdlc-framework.md`](./docs/sdlc-framework.md)                                                      | Framework structure, tiers, adapter layering, schematic                                                                                                                               |
| [`docs/skills.md`](./docs/skills.md)                                                                      | The six AI skills + when each fires + what artefact each leaves on the portal                                                                                                         |
| [`docs/compliance-gates.md`](./docs/compliance-gates.md)                                                  | The five CI workflows + how to interpret a red badge                                                                                                                                   |
| [`docs/evidence-tiers.md`](./docs/evidence-tiers.md)                                                      | Tier 1 / 2 / 3 evidence taxonomy + upload-path split                                                                                                                                  |
| [`docs/change-workflows.md`](./docs/change-workflows.md)                                                  | Change types → workflow → release type; tracked vs housekeeping                                                                                                                       |
| [`docs/e2e-test-tiers.md`](./docs/e2e-test-tiers.md)                                                      | The 3-tier E2E gating model (smoke / critical / regression)                                                                                                                            |
| **Operator walkthroughs**                                                                                 |                                                                                                                                                                                       |
| [`docs/onboarding.md`](./docs/onboarding.md)                                                              | `install` walkthrough — first time on a project                                                                                                                                       |
| [`docs/consuming-projects.md`](./docs/consuming-projects.md)                                              | `update` walkthrough — keeping a consumer in sync                                                                                                                                     |
| [`docs/governance-templates.md`](./docs/governance-templates.md)                                          | Five starter templates (ROPA, DPIA, AI disclosure, incident report, periodic review) + per-framework mapping. **Replace before going to production.**                                  |
| [`docs/e2e-local-db-ci.md`](./docs/e2e-local-db-ci.md)                                                    | Running the E2E gate against a disposable local DB (`e2e_setup_command` + `e2e_env`)                                                                                                  |
| [`sdlc/files/_common/implementing-an-sdlc-issue.md`](./sdlc/files/_common/implementing-an-sdlc-issue.md)  | Operational stage-by-stage walkthrough (also synced to every consumer's `SDLC/`)                                                                                                       |
| **Extending the framework**                                                                               |                                                                                                                                                                                       |
| [`docs/adding-a-stack.md`](./docs/adding-a-stack.md)                                                      | Stack-adapter contract; adding Go / Rust / Ruby / etc.                                                                                                                                |
| [`docs/adding-a-host.md`](./docs/adding-a-host.md)                                                        | Host-adapter contract; adding Vercel / Render / Fly / etc.                                                                                                                            |
| [`docs/adding-a-skill.md`](./docs/adding-a-skill.md)                                                      | Authoring a new project-specific or framework-level skill                                                                                                                              |
| [`docs/ADR/`](./docs/ADR/)                                                                                | Architecture Decision Records for the framework itself                                                                                                                                |
| [`docs/devaudit-cli/`](./docs/devaudit-cli/)                                                              | CLI design + build plan                                                                                                                                                                |
| [`INSTRUCTIONS.md`](./INSTRUCTIONS.md)                                                                    | Working conventions for this repo (maintainer reference)                                                                                                                              |
