...
- **Primary REQ under review:** [what the tracked change itself delivers]
- **Bundled follow-up / housekeeping changes:** [brief list of follow-up PRs, template syncs, CI fixes, or predecessor bare-date releases absorbed into this cut]
- **Evidence split:** [which test/security results prove the core REQ vs which ones simply keep the broader release train green]
...
- Core REQ security impact: [what changed for the tracked requirement]
- Bundled non-core changes: [template sync / CI fix / housekeeping / predecessor release absorbed]
- Reference: `compliance/pending-releases/BUNDLED-CHANGES-REQ-XXX.md`
EOF
```
...
## Bundled Release Context
[Only include this section when `BUNDLED-CHANGES-REQ-XXX.md` exists.]
- Bundle consolidation / release re-anchoring work performed: [yes/no + details]
- Follow-up PRs or predecessor releases folded into this cut: [list]
- Reference: `compliance/pending-releases/BUNDLED-CHANGES-REQ-XXX.md`
...
- **Follow-up PRs in this final release cut:** [PR numbers / short descriptions]
- **Why they are bundled here:** [release re-anchoring / CI fix / framework sync / housekeeping consolidation]
- **Generated bundle evidence:** `compliance/pending-releases/BUNDLED-CHANGES-REQ-XXX.md`
