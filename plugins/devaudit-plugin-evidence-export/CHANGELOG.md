...
All notable changes to `@metasession/devaudit-plugin-evidence-export` are documented here. The plugin follows semver.

## [Unreleased]

## [0.1.0] — 2026-05-19

First public release. Package renamed from unscoped `devaudit-plugin-evidence-export` to scoped `@metasession/devaudit-plugin-evidence-export`. Repo flipped public; Apache-2.0 licensed. Published to npmjs.org with SLSA provenance. No behaviour change from v0.0.1.
