...
Most skills are atomic — they own one slice of one stage. Some — like the shipped [`sdlc-implementer`](../sdlc/files/_common/skills/sdlc-implementer/SKILL.md) — orchestrate multiple stages and benefit from calling other shipped skills as sub-procedures rather than re-implementing their logic.
