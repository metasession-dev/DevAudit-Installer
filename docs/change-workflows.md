...
| **Housekeeping**                     | `chore`, `ci`, `build`, `test`, `compliance`, `revert` | **No**                        | Straight to a `chore:`/`ci:` PR                 | Local gates still run; no requirement, no evidence pack, no SoT-alignment skill invocations                                                                                                                                                                                                                                                                                                                                                              |
